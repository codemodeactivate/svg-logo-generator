...
function createLogo(logoShape, logoTextColor, logoText, logoShapeColor) {
  ...
  return `<svg version="1.1" width="300px" height="200px" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    ${logoShape.render(logoShapeColor)}
    <text x="50%" y="50%" text-anchor="middle" fill="${logoTextColor}" font-size="50">${logoText}</text>
  </svg>`
}
